      ...
      <main className='flex justify-center w-full h-screen'>
        <div className="flex container">
          <div className="flex justify-center items-center w-full h-full">
            <div>
              <h1 className="font-bold text-4xl my-2 fade-left duration-500">
                Assessment Task<br />For Founding Engineer Role
              </h1>
              <hr />
              <p className="text-2xl my-2 opacity-0 fade-left duration-500 delay-250">
                Morgan Mastrangelo
              </p>
